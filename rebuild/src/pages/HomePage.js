        ...
        <React.Fragment>
            <div className='w-screen h-screen grid grid-rows-2 xl:grid-cols-2 bg-bgDark'>
                <div className='w-full h-full bg-bgDark xl:h-screen text-primary centered flex-col'>
                    ...
                    <h2 className='text-secondary text-4xl ml-32 mt-14'>{t('Ingénieur fullstack, travaillant actuellement pour IIDRE, et à la recherche de nouvelles opportunités de travail !')}</h2>
                </div>
